...
Revision ID: 9093e06cfb4a
Revises: 
Create Date: 2026-09-18 14:49:52.653006
...
def upgrade() -> None:
    ...
    sa.Column('security_questions', sa.Enum('MOTHER_MAIDEN_NAME', 'CHILDHOOD_FRIEND', 'FAVORITE_COLOR', 'BIRTH_CITY', name='securityquestionsschema'), nullable=False),
